const translations = {
  es: {
    ...
    nav_who: 'Para quién',
    nav_blog: 'Blog',
    cta_start: 'Inscríbete en nuestra Beta',
    ...
    blog_pill: 'Blog MiniLearn',
    blog_title: 'Ideas para aprender mejor con IA',
    blog_subtitle: 'Artículos cortos, tácticos y aplicables sobre aprendizaje, tecnología y diseño de rutas.',
    blog_featured: 'Destacado',
    blog_latest: 'Últimos artículos',
    blog_card6_title: 'Adiós a la Procrastinación: El secreto de avanzar un 1% cada día',
    blog_card6_body: 'El sistema de 3 minutos diarios para vencer el todo-o-nada y sostener progreso real.',
    blog_card6_tag: 'Productividad',
    blog_card5_title: '5 Minutos al Día: Cómo las Cápsulas Diarias hackean tu cerebro para aprender mejor',
    blog_card5_body: 'Repetición breve, fricción mínima y aprendizaje que sí se queda.',
    blog_card5_tag: 'Microlearning',
    blog_card4_title: 'Microlearning vs Cursos Tradicionales: por qué las sesiones cortas ganan',
    blog_card4_body: 'Más retención, menos fricción y progreso real en bloques de 5 minutos.',
    blog_card4_tag: 'Microlearning',
    blog_read: 'Leer artículo',
    blog_back_home: 'Volver a MiniLearn',
  },
  en: {
    lang_label: 'Language',
    nav_product: 'Problem',
    ...
    nav_blog: 'Blog',
    cta_start: 'Sign up for our Beta',
    cta_team: 'Talk to us',
    ...
    blog_pill: 'MiniLearn Blog',
    blog_title: 'Ideas to learn better with AI',
    blog_subtitle: 'Short, tactical, actionable articles on learning, technology, and path design.',
    blog_featured: 'Featured',
    blog_latest: 'Latest articles',
    blog_card6_title: 'Goodbye to Procrastination: The secret to getting 1% better every day',
    blog_card6_body: 'The 3-minute daily system to beat all-or-nothing and build real progress.',
    blog_card6_tag: 'Productivity',
    blog_card5_title: '5 Minutes a Day: How daily capsules hack your brain to learn better',
    blog_card5_body: 'Short repetition, low friction, and learning that sticks.',
    blog_card5_tag: 'Microlearning',
    blog_card4_title: 'Microlearning vs Traditional Courses: why short sessions win',
    blog_card4_body: 'Higher retention, lower friction, and real progress in 5‑minute blocks.',
    blog_card4_tag: 'Microlearning',
    blog_read: 'Read article',
    blog_back_home: 'Back to MiniLearn',
  },
};
